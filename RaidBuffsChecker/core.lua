...
local PersonalBuff = CreateFrame("Frame", "RaidBuffsCheckerPersonalFrame", UI.PetBattleHider)
...
--   -------- -------- -------- -------- --------      -------- -------- -------- -------- -------- --------
local RaidBuff = CreateFrame("Frame", "RaidBuffsCheckerFrame", PersonalBuff)
...
-- Toggle button
local RaidBuffToggle = CreateFrame("Frame", "RaidBuffsCheckerToggleFrame", PersonalBuff)
